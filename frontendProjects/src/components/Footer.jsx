...
const Footer = ({theme}) => {
  ...
  viewport={{ once: true }}
        className='text-gray-600 dark:text-gray-400'>
            ...
            <div className='flex gap-2 text-sm'>
                <input className='w-full p-3 text-sm outline-none rounded dark:text-gray-200 bg-transparent border border-gray-300 dark:border-gray-500' type="email" placeholder='Enter your email' />
  ...
  viewport={{ once: true }}
      className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
        <p>Copyright 2025 © azeemtech  -  All Right Reserved</p>
