...
// console.log(this)  // if it check in browser then it prints "Window" object
...
// {
//     let username="aazeem"
//     console.log(this.username)   // We see that "this" is only works in objects not in functions
// }
